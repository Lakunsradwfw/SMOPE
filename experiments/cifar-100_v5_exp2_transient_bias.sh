# bash experiments/cifar-100_v5_exp2_transient_bias.sh
# v5 ablation: transient prompt probe only biases router selection.
...
python -u run.py --config configs/cifar-100_prompt_smope.yaml --gpuid $GPUID --repeat $REPEAT --overwrite $OVERWRITE \
    ...
    --experiment_version v5_exp2_transient_bias \
    --log_dir ${OUTDIR}/v5-exp2-transient-bias-topk${ACTIVE_TOPK}
